...
[Verified] and extends consistently to eight further rule-derived rungs
GF6, GF10, GF14, GF48, GF96, GF128 [Conj] and GF512, GF1024
[Conj, rule extrapolation; bias $2^{194}-1$, $2^{390}-1$ exceeds the
\texttt{u128} ROM record field and is tracked symbolically]. We
...
% PLACEHOLDER: Table 1 with 17 formats (N, e, m, raw, ratio).
%   Top block (9 realised silicon/RTL): GF4, GF8, GF12, GF16, GF20,
%       GF24, GF32, GF64, GF256.
%   Middle block (6 rule-derived, no returned silicon): GF6, GF10,
%       GF14, GF48, GF96, GF128.
%   Bottom block (2 rule extensions; bias > u128, symbolic):
%       GF512, GF1024.
...
% NOTE: 17-format narrowing recomputation is OPEN; do not cite a
%       17-format figure until claim-audit-lab CASE-09 is closed.
