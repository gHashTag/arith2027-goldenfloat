...
3. **One hardware artefact** — a GF16 codec on Artix-7 FPGA passing a 35-of-35 testbench (the earlier 323 MHz timing figure was withdrawn after review) — plus a pre-registered matched-substrate head-to-head experiment against posit-16, takum-16, and binary16 on the same board.
...
The scaffold is currently a skeleton with `% PLACEHOLDER` comments marking each subsection. Content is filled in iteratively from the live arXiv version ([arXiv:2606.05017](https://arxiv.org/abs/2606.05017) v3, 20 pages, cs.AR; the v4 erratum announces 7 Sep 2026) following the page budget in `paper/OUTLINE.md`.
